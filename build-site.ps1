...
$magazineArticles = @(
  @{
    slug="hotel-aroma-review"; title="호텔 숙소 아로마테라피 이용 후기"; category="숙소 이용 사례"; area="부산 해운대 숙소"; service="아로마테라피 90분"; date="2026-05-29"; desc="호텔 숙소에서 아로마테라피를 예약할 때 확인해야 할 프런트 출입, 향 민감도, 요금 안내, 관리 전 준비사항을 익명 사례로 정리했습니다."; excerpt="프런트 출입 기준과 향 민감도 확인이 만족도를 좌우했던 숙소 이용 사례입니다."; paragraphs=@(
      "이 글은 실제 예약 상담에서 반복적으로 확인된 질문을 바탕으로 개인정보를 제거하고 재구성한 후기형 안내입니다. 특정 고객을 그대로 소개하지 않으며, 숙소명과 객실 정보는 공개하지 않습니다. 사례의 핵심은 마사지 자체를 과장하는 것이 아니라 호텔이나 숙소에서 출장마사지를 이용할 때 어떤 절차를 먼저 확인해야 대기와 오해를 줄일 수 있는지에 있습니다.",
      "상담은 저녁 식사 뒤 숙소에서 조용히 쉬고 싶다는 문의로 시작되었습니다. 고객은 강한 압보다 오일을 사용한 부드러운 관리를 원했고, 다음 날 오전 이동 일정이 있어 너무 늦게 끝나는 코스는 부담스럽다고 말했습니다. 상담팀은 지역, 숙소 유형, 프런트 외부 방문 정책, 엘리베이터 이용 기준, 향에 민감한지 여부를 먼저 확인했습니다. 이 단계가 길어 보일 수 있지만 실제 방문에서는 가장 중요한 절차입니다.",
      "예약 과정에서 좋았던 점은 요금과 추가 조건을 미리 나누어 안내한 부분입니다. 기본 관리 시간과 금액, 심야 시간대 적용 여부, 주차가 어려울 때 대기 시간이 생길 수 있다는 점을 상담 중에 설명했습니다. 고객 입장에서는 막연한 최저가보다 실제로 지불할 가능성이 있는 범위를 먼저 듣는 편이 안심됩니다. 88마사지는 현장에서 갑자기 조건이 바뀌지 않도록 관리 종류와 이동 조건을 예약 전에 정리합니다.",
      "관리 전 준비는 단순했습니다. 객실 안에서 타월과 매트를 펼칠 공간을 만들고, 향이 오래 남는 것이 부담스러운지 확인했습니다. 오일 관리는 향과 터치감이 장점이지만 모든 사람에게 같은 향이 편한 것은 아닙니다. 그래서 상담 단계에서 향 민감도와 피부 자극 경험을 묻고, 강한 압이나 치료 효과를 약속하지 않는다는 점을 다시 설명했습니다. 휴식 관리라는 범위를 분명히 하는 것이 신뢰를 만드는 기준입니다.",
      "이 사례에서 얻을 수 있는 정보는 숙소 예약자가 미리 준비할 항목입니다. 숙소명보다 실제 출입 방식, 프런트 안내 기준, 객실에서 받을 수 있는 공간, 시작 가능한 시간, 다음 일정까지의 여유가 중요합니다. 후기를 읽고 바로 같은 코스를 고르기보다 자신의 일정과 공간 조건을 먼저 확인하는 것이 좋습니다. 이 글은 의료 효과나 통증 개선을 보장하지 않으며, 컨디션이 좋지 않다면 이용을 미루는 판단이 우선입니다."
    )
  },
  @{
    slug="office-swedish-review"; title="야근 후 스웨디시 예약 후기"; category="퇴근 후 이용 사례"; area="서울 강남 업무지"; service="스웨디시 90분"; date="2026-05-29"; desc="야근 뒤 스웨디시를 예약한 고객 사례를 바탕으로 시작 시간, 오피스텔 출입, 압 조절, 무리 없는 관리 범위를 정리했습니다."; excerpt="퇴근 시간이 늦어지는 상황에서 시작 시간과 압 조절을 어떻게 맞췄는지 정리한 후기입니다."; paragraphs=@(
      "야근 후 문의는 시간이 촉박하다는 특징이 있습니다. 이 후기는 서울 업무지구에서 늦은 시간 스웨디시 관리를 상담한 사례를 익명화해 정리했습니다. 실제 고객의 이름, 회사, 건물 정보는 남기지 않았고, 예약자가 참고할 수 있는 절차와 판단 기준만 남겼습니다. 검색 노출용으로 감정적인 칭찬을 늘리기보다 예약 전 어떤 정보를 확인해야 하는지에 초점을 맞췄습니다.",
      "고객은 강한 지압보다 부드러운 압과 조용한 진행을 원했습니다. 업무가 늦게 끝났고 다음 날도 출근해야 했기 때문에 긴 코스보다 90분 정도가 적당했습니다. 상담팀은 먼저 희망 시작 시간보다 실제 도착 가능 시간을 확인했습니다. 업무지구는 밤에도 차량 정차가 어렵거나 건물 출입이 제한되는 경우가 있어, 주소만 받는 것으로는 충분하지 않습니다. 공동현관, 엘리베이터, 주차 가능 여부까지 확인해야 합니다.",
      "스웨디시를 선택한 이유는 강한 자극이 부담스럽다는 점이었습니다. 상담에서는 어깨가 무겁다는 표현이 있었지만 치료나 통증 개선을 약속하지 않았습니다. 대신 관리 중 압을 낮게 시작하고, 불편한 부위가 있으면 즉시 조절하는 방식으로 안내했습니다. 이런 설명은 과장된 효과보다 실제 이용 경험에 더 가깝습니다. 출장마사지는 관리 기술뿐 아니라 고객이 안심하고 요청을 말할 수 있는 분위기도 중요합니다.",
      "예약 후 고객이 긍정적으로 본 부분은 시간 안내였습니다. 바로 가능하다는 식의 답보다 예상 도착 시간, 준비 시간, 종료 시간을 현실적으로 들은 점이 도움이 됐습니다. 야근 뒤에는 피로감 때문에 판단이 급해질 수 있지만, 무리하게 긴 코스를 고르면 다음 일정에 부담이 될 수 있습니다. 88마사지는 처음 이용하는 고객에게 강한 압이나 긴 시간을 무조건 권하지 않고, 컨디션과 일정에 맞는 범위를 먼저 설명합니다.",
      "이 사례의 핵심은 스웨디시라는 이름보다 예약자의 상태를 어떻게 설명하느냐입니다. 조용한 진행, 낮은 압, 피하고 싶은 부위, 관리 후 바로 쉬어야 하는 일정이 있다면 상담 단계에서 말하는 편이 좋습니다. 음주 직후나 발열, 급성 통증이 있다면 예약을 미루는 것이 안전합니다. 후기는 참고 자료일 뿐이며 모든 고객에게 같은 결과를 보장하지 않습니다. 건전한 휴식 관리의 범위를 지키는 것이 가장 중요한 기준입니다."
    )
  },
  @{
    slug="home-lymph-review"; title="자택 림프마사지 예약 후기"; category="자택 이용 사례"; area="경기 신도시 아파트"; service="림프마사지 90분"; date="2026-05-29"; desc="자택에서 림프마사지를 이용할 때 가족 동선, 반려동물, 공동현관, 가벼운 압 조절을 어떻게 확인하는지 정리했습니다."; excerpt="자택 공간에서 조용한 방문과 가벼운 압을 우선한 예약 사례입니다."; paragraphs=@(
      "자택 이용 후기는 숙소나 오피스텔 사례와 다르게 생활 공간의 동선이 중요합니다. 이 글은 경기권 아파트에서 림프마사지를 상담한 사례를 개인정보 없이 재구성했습니다. 실제 동, 단지명, 세대 정보는 공개하지 않습니다. 후기를 가장한 홍보 문구가 아니라, 가족이 함께 있는 공간에서 어떤 준비와 확인이 필요한지 알려 주는 안내 글로 작성했습니다.",
      "고객은 강한 압이 부담스럽고 몸이 무겁게 느껴져 가벼운 압의 관리를 원했습니다. 상담팀은 림프마사지가 질병 치료나 의학적 처치가 아니라 휴식 관리라는 점을 먼저 안내했습니다. 이어서 관리 공간, 가족의 이동 동선, 반려동물 분리 가능 여부, 공동현관 호출 방식, 지하 주차장 진입 기준을 확인했습니다. 자택 예약에서는 관리사의 도착보다 조용하고 안전한 환경을 만드는 것이 먼저입니다.",
      "좋았던 점은 준비해야 할 내용을 과하게 만들지 않았다는 부분입니다. 넓은 방이 꼭 필요한 것은 아니며 타월이나 매트를 펼칠 수 있는 공간, 환기, 귀중품 정리 정도면 충분했습니다. 다만 가족이 오가는 거실보다 문을 닫을 수 있는 방이 더 편했고, 반려동물이 있다면 관리 중 방해가 없도록 미리 분리하는 편이 좋습니다. 이런 준비는 서비스 품질뿐 아니라 고객과 관리사 모두의 안전을 위한 기준입니다.",
      "림프마사지는 가벼운 압과 일정한 방향의 터치가 중심이지만, 모든 고객에게 같은 느낌으로 맞지는 않습니다. 상담에서는 민감한 부위, 피하고 싶은 압, 오일 사용 가능 여부를 확인했습니다. 관리 중에는 압이 너무 약하거나 강하게 느껴질 때 바로 말할 수 있도록 안내했습니다. 후기를 보면 만족이라는 단어만 보이기 쉽지만, 실제 만족도는 이런 소통 과정에서 결정되는 경우가 많습니다.",
      "이 사례에서 얻을 수 있는 조언은 자택 예약일수록 주소보다 생활 조건을 먼저 정리하라는 것입니다. 공동현관, 주차, 엘리베이터, 가족 동선, 반려동물, 관리받을 공간, 원하는 압을 알려 주면 상담이 훨씬 정확해집니다. 단, 붓기나 통증 같은 표현이 있더라도 효과를 보장하지 않습니다. 건강 이상이 의심되면 마사지를 예약하기보다 의료 전문가와 상담하는 것이 우선입니다."
    )
  },
  @{
    slug="business-trip-deeptissue-review"; title="출장 일정 뒤 딥티슈 이용 후기"; category="비즈니스 이동 사례"; area="인천 송도 숙소"; service="딥티슈 90분"; date="2026-05-29"; desc="출장 일정 뒤 딥티슈 관리를 상담한 사례로 이동 피로, 집중 부위, 강도 조절, 숙소 출입 확인 기준을 안내합니다."; excerpt="장거리 이동 뒤 특정 부위가 무거울 때 강도와 시간을 어떻게 정했는지 정리했습니다."; paragraphs=@(
      "출장 일정 뒤에는 몸이 무겁다는 표현이 자주 나오지만, 그 말만으로 어떤 관리가 맞는지 정하기는 어렵습니다. 이 글은 인천 숙소에서 딥티슈 관리를 상담한 사례를 익명화한 후기형 콘텐츠입니다. 특정 호텔명, 회사명, 개인 일정은 제외했습니다. 목적은 서비스를 과장해 보이게 만드는 것이 아니라 장거리 이동 뒤 예약자가 실제로 확인해야 할 내용을 정리하는 데 있습니다.",
      "고객은 등과 하체가 단단하게 느껴진다고 말했고, 일반적인 릴랙스보다 특정 부위 중심의 관리를 원했습니다. 상담팀은 먼저 통증의 정도와 외상 여부, 발열이나 급성 증상이 없는지 확인했습니다. 딥티슈라는 이름이 강한 압을 의미한다고 생각하기 쉽지만, 처음부터 세게 누르는 방식은 권하지 않습니다. 고객의 반응을 보며 단계적으로 압을 조절하고 불편하면 즉시 멈추는 것이 더 중요합니다.",
      "숙소 이용에서는 출입 확인도 필요했습니다. 프런트 정책, 엘리베이터 이용, 주차 또는 정차 가능 여부, 예약명 확인 방식이 도착 시간에 영향을 줍니다. 특히 출장 고객은 회의가 늦어져 시작 시간이 바뀌는 일이 있어, 가능한 시간과 변경 기준을 미리 듣는 것이 좋습니다. 이 사례에서는 90분이 적당했습니다. 60분은 특정 부위만 보기 쉽고, 120분은 다음 일정이 있는 고객에게 부담이 될 수 있었기 때문입니다.",
      "후기에서 긍정적으로 볼 만한 지점은 강도 조절에 대한 설명이었습니다. 고객은 강하게 받고 싶다고 했지만 상담팀은 무조건 강한 압이 좋은 것은 아니라고 안내했습니다. 등, 어깨, 하체처럼 집중 부위를 나누고 관리 중 느낌을 확인하는 방식이 더 안전합니다. 또한 치료, 회복 보장, 질환 개선 같은 표현은 사용하지 않았습니다. 출장마사지는 피로한 날의 휴식 관리이지 의료 서비스를 대체하지 않습니다.",
      "이 사례가 주는 정보는 딥티슈를 고를 때 부위와 강도를 구체적으로 말해야 한다는 점입니다. 단순히 피곤하다고 말하는 것보다 등 중심, 하체 중심, 강한 압이 부담스러운 부위, 피해야 할 자세를 알려 주면 상담이 정확해집니다. 숙소 출입 조건과 종료 후 휴식 가능 시간도 함께 봐야 합니다. 후기는 참고용이며 모든 고객에게 같은 만족을 보장하지 않습니다."
    )
  },
  @{
    slug="first-time-thai-review"; title="처음 이용한 타이마사지 예약 후기"; category="첫 이용 사례"; area="서울 마포 숙소"; service="타이마사지 60분"; date="2026-05-29"; desc="처음 출장마사지를 이용하는 고객이 타이마사지 60분을 선택할 때 확인한 스트레칭, 복장, 공간, 압 조절 기준을 안내합니다."; excerpt="처음 이용자가 부담을 줄이기 위해 60분 코스와 준비사항을 확인한 사례입니다."; paragraphs=@(
      "처음 출장마사지를 이용하는 고객은 서비스보다 절차가 더 궁금한 경우가 많습니다. 이 글은 서울 숙소에서 타이마사지를 처음 상담한 사례를 개인정보 없이 재구성했습니다. 고객의 이름, 숙소명, 세부 주소는 제외했고, 첫 이용자가 실제로 궁금해할 만한 예약 흐름과 준비사항만 남겼습니다. 후기라는 이름을 쓰지만 과장된 만족 표현보다 확인 과정에 초점을 맞췄습니다.",
      "고객은 타이마사지가 스트레칭 중심이라는 점은 알고 있었지만, 어느 정도 움직임이 필요한지 몰라 부담을 느꼈습니다. 상담팀은 60분 코스로 시작하는 것을 안내했습니다. 처음부터 긴 시간을 선택하기보다 짧은 시간으로 압과 자세가 맞는지 확인하는 편이 좋기 때문입니다. 또한 스트레칭이 포함되는 관리는 공간과 복장이 중요하므로, 매트를 펼칠 수 있는지와 편한 옷을 준비할 수 있는지 확인했습니다.",
      "타이마사지를 선택할 때 주의할 점은 강한 지압과 스트레칭을 무조건 견뎌야 한다고 생각하지 않는 것입니다. 고객이 불편함을 느끼면 강도와 범위를 줄일 수 있어야 합니다. 상담에서는 허리나 목처럼 조심해야 할 부위가 있는지, 최근 외상이나 급성 통증이 있는지 확인했습니다. 의학적 문제가 의심되면 관리를 진행하기보다 전문가 상담이 우선이라는 안내도 함께 했습니다.",
      "방문 전에는 숙소 출입 기준, 엘리베이터 이용, 관리 공간, 시작 시간을 확인했습니다. 첫 이용자는 무엇을 준비해야 하는지 몰라 긴장할 수 있지만, 실제로는 공간 정리와 복장, 주차 또는 공동현관 정보 정도가 핵심입니다. 상담팀이 순서대로 물어보면 고객도 필요한 정보를 정리하기 쉽습니다. 이 과정은 예약 전 불안을 줄이고 현장에서 설명하느라 시간을 쓰는 일을 줄여 줍니다.",
      "이 사례의 결론은 첫 이용일수록 짧고 명확하게 시작하는 것이 좋다는 점입니다. 타이마사지 60분은 서비스 흐름을 경험하고 본인에게 맞는지 확인하기에 부담이 적었습니다. 이후 더 긴 시간이 필요하다면 다음 예약에서 조정할 수 있습니다. 후기를 그대로 따라 하기보다 자신의 컨디션, 공간, 일정, 피해야 할 자세를 먼저 생각해 보세요. 88마사지는 건전한 휴식 관리 범위 안에서만 예약을 안내합니다."
    )
  }
)
...
function Layout($title, $description, $path, $body, $schemaType, $areaServed) {
  ...
  if ($schemaType -eq "BlogPosting") {
    $schema.author = @{"@type"="Organization"; name="$brand 고객센터 운영팀"; url=$siteUrl}
    $schema.publisher = @{"@type"="Organization"; name=$brand; legalName=$company; url=$siteUrl; logo=@{"@type"="ImageObject"; url="$siteUrl/assets/og-image.svg"}}
    $schema.datePublished = $today
    $schema.dateModified = $today
    $schema.image = "$siteUrl/assets/hero-wellness.png"
...
function Build-MagazineIndex {
  $cards = ($magazineArticles | ForEach-Object {
    "<a class=`"link-card`" href=`"/magazine/$($_.slug)/`"><strong>$($_.title)</strong><span>$($_.category) · $($_.area) · $($_.excerpt)</span></a>"
  }) -join ""
  $body = Hero "후기 매거진" "88마사지 이용 후기 매거진" "실제 상담에서 반복적으로 확인되는 질문과 이용 전 준비사항을 개인정보 없이 재구성한 후기형 안내입니다. 특정 고객을 그대로 노출하지 않고, 예약자가 판단할 수 있는 절차와 기준을 중심으로 정리합니다."
  $body += Section "매거진 운영 기준" "88마사지 매거진은 검색 순위를 위해 짧은 후기를 대량으로 늘리는 방식으로 운영하지 않습니다. 글마다 작성일, 검수일, 작성 주체, 재구성 기준을 밝히고, 실제 예약 상담에서 반복되는 질문을 바탕으로 내용을 정리합니다. 후기처럼 읽히더라도 개인의 치료 효과, 질병 개선, 통증 해소를 보장하지 않습니다. 숙소명, 상세 주소, 고객 신상, 관리사 개인 정보는 공개하지 않으며 안전한 예약 판단에 필요한 정보만 남깁니다."
  $body += "<section class=`"grid-section`"><h2>후기 5개</h2><div class=`"card-grid`">$cards</div></section>"
  $body += Section "후기를 읽는 방법" "후기는 같은 서비스를 그대로 따라 하라는 의미가 아닙니다. 호텔, 자택, 오피스텔, 업무 공간은 출입 방식과 준비물이 다르고, 스웨디시, 아로마테라피, 딥티슈, 타이마사지, 림프마사지는 압과 진행 방식이 다릅니다. 따라서 글을 읽을 때는 만족 표현보다 예약 전 확인한 정보, 공간 준비, 요금 안내, 압 조절, 피해야 할 상황을 중심으로 보는 것이 좋습니다. 이 기준이 실제 이용 전 판단에 더 도움이 됩니다."
  $body += Section "후기 5개 구성" "이번 매거진은 호텔 숙소, 야근 후 업무지, 자택 아파트, 출장 일정 뒤 숙소, 처음 이용하는 고객처럼 서로 다른 상황을 나누었습니다. 지역명만 바꾸는 글이 아니라 장소 유형, 관리 목적, 예약 전 확인한 조건이 다르게 보이도록 구성했습니다. 독자는 자신과 가장 가까운 상황을 먼저 읽고, 출입 조건과 관리 시간, 압 조절, 이용을 미뤄야 하는 상태를 체크하면 됩니다."
  $body += Section "작성자와 검수" "모든 매거진 글은 88마사지 고객센터 운영팀이 작성하고 책임 편집자가 표현을 검수합니다. 상담 기록을 바탕으로 하되 개인을 식별할 수 있는 정보는 삭제하고, 여러 유사 문의에서 공통적으로 확인된 절차를 하나의 사례로 정리합니다. AI 도구를 사용해 초안을 정리하더라도 최종 문구는 사업자 정보, 요금 안내, 금지 표현, 의료적 오해 가능성을 기준으로 다시 확인합니다. 독자가 누가, 어떻게, 왜 작성했는지 알 수 있도록 각 글 상단에 바이라인을 표시합니다."
  $body += Section "안전과 한계" "출장마사지 후기는 휴식 관리 선택을 돕는 참고 자료입니다. 특정 증상 개선, 치료, 회복, 의학적 효과를 약속하지 않으며 건강 이상이 의심되는 경우 의료 전문가 상담이 우선입니다. 음주 직후, 발열, 외상, 급성 통증, 피부 이상처럼 안전한 진행이 어려운 상태에서는 예약을 미루는 것이 좋습니다. 88마사지는 건전한 휴식 관리 기준에 맞지 않는 요청을 받지 않고, 확인된 조건 안에서만 예약 가능 여부를 안내합니다."
  $body += Section "색인과 콘텐츠 품질 기준" "매거진 페이지는 RSS와 사이트맵에 포함되지만, 색인만을 목적으로 짧은 문서를 반복 발행하지 않습니다. 새 글은 실제 상담에서 반복되는 질문이 있거나 이용자가 예약 전에 확인할 정보가 충분할 때만 공개합니다. 후기 문구는 별점 경쟁보다 정보의 선명함을 우선하며, 이미 지역 페이지에 있는 요금표나 서비스 설명을 그대로 복사하지 않습니다. 이 원칙은 사이트 전체 품질을 지키기 위한 운영 기준입니다."
  $body += Section "예약 전 공통 체크" "후기를 읽은 뒤 문의할 때는 지역, 희망 시간, 공간 유형, 원하는 관리, 피해야 할 압, 주차나 출입 기준을 먼저 정리해 주세요. 이 정보가 있어야 상담팀이 가능 여부와 예상 도착 시간을 더 현실적으로 안내할 수 있습니다."
  $body += FaqBlock @(
    @{q="매거진 후기는 실제 고객 후기인가요?"; a="상담에서 반복된 이용 상황을 개인정보 없이 재구성한 후기형 안내입니다. 특정 개인을 그대로 노출하지 않습니다."},
    @{q="후기와 같은 결과를 기대해도 되나요?"; a="아닙니다. 공간, 컨디션, 시간대, 관리 종류에 따라 경험은 달라질 수 있으며 효과를 보장하지 않습니다."},
    @{q="왜 후기마다 작성 기준을 표시하나요?"; a="누가, 어떻게, 왜 작성했는지 알 수 있어야 예약자가 정보를 더 신뢰하고 판단할 수 있기 때문입니다."}
  )
  return Layout "88마사지 매거진 | 출장마사지 이용 후기와 예약 안내" "88마사지 매거진은 출장마사지 이용 후기 5개와 예약 전 확인사항을 개인정보 없이 재구성해 안내합니다." "/magazine/" $body "CollectionPage" "대한민국"
}

function Build-MagazineArticle($article) {
  $related = ($magazineArticles | Where-Object { $_.slug -ne $article.slug } | Select-Object -First 4 | ForEach-Object {
    "<a class=`"pill`" href=`"/magazine/$($_.slug)/`">$($_.title)</a>"
  }) -join ""
  $body = Hero $article.category $article.title "$($article.excerpt) $($article.service)을 기준으로 예약 전 확인한 내용과 이용 후 남길 수 있는 실질적인 판단 기준을 정리했습니다."
  $body += "<section class=`"content-section`"><h2>작성 정보</h2><p>작성자: 88마사지 고객센터 운영팀 · 검수: 책임 편집자 김유환 · 작성일: $($article.date) · 사례 기준: $($article.area), $($article.service). 이 글은 개인정보를 제거한 익명 상담 사례이며 치료, 진단, 효과 보장을 목적으로 하지 않습니다.</p></section>"
  $body += Section "사례 개요" $article.paragraphs[0]
  $body += Section "예약 상담 과정" $article.paragraphs[1]
  $body += Section "확인한 조건" $article.paragraphs[2]
  $body += Section "관리 전 안내" $article.paragraphs[3]
  $body += Section "후기에서 얻을 점" $article.paragraphs[4]
  $body += Section "예약 전 체크리스트" "$($article.area)에서 $($article.service)을 상담할 때는 지역명보다 실제 방문 조건을 먼저 정리하는 것이 좋습니다. 희망 시작 시간, 관리받을 공간, 공동현관이나 프런트 기준, 주차 가능 여부, 원하는 압, 피해야 할 부위, 결제 방식, 추가 출장비 가능성을 한 번에 확인하면 현장 혼선을 줄일 수 있습니다. 처음 이용하는 경우에는 너무 긴 시간보다 본인에게 맞는 압과 진행 방식을 확인할 수 있는 시간부터 선택하는 편이 안전합니다."
  $body += Section "공개하지 않는 정보" "후기에는 고객 실명, 세부 주소, 숙소명, 객실 정보, 관리사 개인 정보, 결제 내역처럼 개인을 식별할 수 있는 내용은 넣지 않습니다. 별점이나 짧은 칭찬만 반복하면 실제 예약 판단에 도움이 되지 않기 때문에 상담에서 확인한 절차와 주의사항을 중심으로 정리합니다. 이 페이지의 내용은 참고용이며 같은 지역과 같은 서비스라도 시간대, 이동 조건, 고객 컨디션에 따라 실제 안내는 달라질 수 있습니다."
  $body += Section "편집 기준" "이 글은 88마사지가 실제 상담에서 반복적으로 확인한 질문을 바탕으로 작성했습니다. 검색 노출을 위해 같은 문장을 복제하지 않고, 장소 유형과 서비스 선택 이유, 예약 전 확인사항을 구분했습니다. 개인정보와 과장 표현은 제거했으며, 의료적 효과처럼 오해될 수 있는 표현은 사용하지 않습니다. 독자가 바로 예약 여부를 판단할 수 있도록 요금, 출입, 시간, 압 조절, 이용을 미뤄야 하는 상황을 함께 안내합니다."
  $body += Section "함께 읽을 후기" $related
  $body += FaqBlock @(
    @{q="이 후기는 의료 효과를 의미하나요?"; a="아닙니다. 휴식 관리 경험을 이해하기 위한 안내이며 치료, 진단, 질환 개선을 보장하지 않습니다."},
    @{q="같은 지역이면 같은 조건으로 예약되나요?"; a="아닙니다. 시간대, 건물 출입, 주차, 관리사 배정 상황에 따라 달라질 수 있습니다."},
    @{q="처음 이용하면 무엇을 먼저 말해야 하나요?"; a="지역, 희망 시간, 공간 유형, 원하는 압, 피해야 할 부위, 주차나 공동현관 기준을 알려 주세요."}
  )
  return Layout "$($article.title) | 88마사지 매거진" $article.desc "/magazine/$($article.slug)/" $body "BlogPosting" $article.area
}
...
$pages += @{path="magazine/index.html"; url="/magazine/"; html=(Build-MagazineIndex); title="88마사지 매거진"; desc="출장마사지 이용 후기와 예약 전 확인사항"}
foreach ($article in $magazineArticles) {
  $path = "magazine/$($article.slug)/index.html"
  $pages += @{path=$path; url="/magazine/$($article.slug)/"; html=(Build-MagazineArticle $article); title=$article.title; desc=$article.desc}
}
